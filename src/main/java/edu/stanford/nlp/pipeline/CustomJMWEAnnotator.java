 ...
 *
 */
public class CustomJMWEAnnotator implements Annotator {
...
//    Requirement JMWE_REQUIREMENT = new Requirement(STANFORD_JMWE);
     ...
     *            the properties
     */
    public CustomJMWEAnnotator(String name, Properties props) {
        // set verbosity
    ...
    public Set<Class<? extends CoreAnnotation>> requirementsSatisfied() {
        return Collections.singleton(edu.stanford.nlp.pipeline.CustomJMWEAnnotator.JMWEAnnotation.class);
    }

    @Override
    public Set<Class<? extends CoreAnnotation>> requires() {
        return Collections.unmodifiableSet(new HashSet<Class<? extends CoreAnnotation>>() {{
            add(CoreAnnotations.TokensAnnotation.class);
            add(CoreAnnotations.SentencesAnnotation.class);
            add(CoreAnnotations.PartOfSpeechAnnotation.class);
            add(CoreAnnotations.LemmaAnnotation.class);
        }});
    }
