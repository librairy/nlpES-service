 ...
 */
public class StanfordWordnetPipeAnnotatorES implements StanfordAnnotator{
    /**
     *
    ...
    private static final Logger LOG = LoggerFactory.getLogger(StanfordWordnetPipeAnnotatorES.class);
    ...
    public StanfordWordnetPipeAnnotatorES(String resourceFolder) {
        ...
        props.put("annotators", "tokenize, ssplit, pos, lemma, jmwe, ner"); //"tokenize, ssplit, pos,
        ...
        // jMWE
        props.setProperty("customAnnotatorClass.jmwe", "edu.stanford.nlp.pipeline.CustomJMWEAnnotator");
