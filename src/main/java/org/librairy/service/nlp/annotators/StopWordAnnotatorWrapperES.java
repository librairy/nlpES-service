 ...
 */
public class StopWordAnnotatorWrapperES implements Annotator, CoreAnnotation<Pair<Boolean, Boolean>> {
...
//    public static final Requirement STOPWORD_REQUIREMENT = new Requirement("stopword");
    ...
    public StopWordAnnotatorWrapperES(String annotatorClass, Properties props) {
        this.props = props;
    ...
    public void annotate(Annotation annotation) {
        if(this.stopwords != null && this.stopwords.size() > 0 && annotation.containsKey(CoreAnnotations.TokensAnnotation.class)) {
            ...
            while(var3.hasNext()) {
                ...
                token.set(StopWordAnnotatorWrapperES.class, pair);
            }
        }
